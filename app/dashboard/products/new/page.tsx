...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isDemoMode || localStorage.getItem('demo_mode') === 'true') {
      alert('Add product functionality is disabled in demo mode. Sign up to manage your real inventory!')
      return
    }
            ...
            <div>
              ...
              <div className="flex">
                ...
                <button
                  type="button"
                  onClick={generateSKU}
                  className="ml-2 px-3 py-2 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200"
                  title="Generate SKU"
                >
                  Generate
                </button>
